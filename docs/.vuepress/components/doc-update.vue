      ...
      list: [
        {
          ...
          list: [
            {
              label: "新增",
              content: "`vk.baseDao.updateAndReturn` API",
              a: {
                text: "点击查看",
                href:
                  "https://vkdoc.fsq.pub/client/uniCloud/db/api.html#%E6%9B%B4%E6%96%B0%E5%B9%B6%E8%BF%94%E5%9B%9E%E6%9B%B4%E6%96%B0%E5%90%8E%E7%9A%84%E6%95%B0%E6%8D%AE-%E5%8E%9F%E5%AD%90%E6%93%8D%E4%BD%9C"
              }
            },
            {
              label: "新增",
              content:
                "`vk.pubfn.getDayOffsetStartAndEnd` 获得相对当前时间的偏移 count 天的起止日期(日的开始和结束)",
              a: {
                text: "点击查看",
                href:
            ...
            },
            {
              label: "新增",
              content:
                "`vk.pubfn.getMonthOffsetStartAndEnd` 获得相对当前时间的偏移 count 月的起止日期(月的开始和结束)",
              a: {
                text: "点击查看",
                href:
            ...
            },
            {
              label: "新增",
              content:
                "`vk.pubfn.getYearOffsetStartAndEnd`获得相对当前时间的偏移 count 年的起止日期(年的开始和结束)",
              a: {
                text: "点击查看",
                href:
            ...
            {
              label: "新增",
              content: "`vk.pubfn.sleep` 进程等待（主要用于在云函数中需要故意等待几秒的情况）",
              a: {
                text: "点击查看",
                href:
                  "https://vkdoc.fsq.pub/client/jsapi.html#vk-pubfn-sleep-%E8%BF%9B%E7%A8%8B%E5%BC%BA%E5%88%B6%E7%AD%89%E5%BE%85-%E4%BC%91%E7%9C%A0"
              }
            },
            {
              label: "新增",
              content: "`app.config.js` 新增参数 `globalErrorCode` 可以修改全局异常的提示信息",
              a: {
                text: "点击查看",
                href: "https://vkdoc.fsq.pub/client/pages/config.html"
              }
            },
            {
              label: "新增",
              content: "`javascript代码块提示.json` 最近新增的api的代码提示",
              a: {
                text: "点击查看",
                href: "https://vkdoc.fsq.pub/client/codeTips.html"
              }
            },
            {
              label: "优化",
              content: "`vk.baseDao.selects`新增参数`addFields`",
              a: {
                text: "点击查看",
                href:
                  "https://vkdoc.fsq.pub/client/uniCloud/db/question.html#%E5%88%86%E7%BB%84count"
              }
            },
            {
              label: "优化",
              content: "`vk.pubfn.timeFormat` 等API，当参数time为字符串时间戳时的特殊处理",
              a: {
                text: "点击查看",
                href:
                  "https://vkdoc.fsq.pub/client/jsapi.html#vk-pubfn-timeformat-%E6%97%A5%E6%9C%9F%E6%A0%BC%E5%BC%8F%E5%8C%96"
              }
            },
            { label: "修复", content: "腾讯云的图片上传无法回显图片的问题。" }
          ]
        },
        {
          version: "2.2.4",
        ...
        },
        {
          ...
          list: [
            { label: "升级", content: "`uni-id` 至 `3.3.3`" },
            {
              ...
              a: {
                text: "点击查看",
                href: "https://vkdoc.fsq.pub/client/uniCloud/cloudfunctions/formRules.html"
              }
            }
          ]
        },
        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              ...
              a: {
                text: "点击查看URL重写规则",
                href: "https://vkdoc.fsq.pub/client/uniCloud/cloudfunctions/urlrewrite.html"
              }
            },
            {
              label: "修复",
